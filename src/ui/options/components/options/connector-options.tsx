		...
		<>
			...
			<ul class={styles.optionList}>
				...
				<ConnectorOptionEntry
					...
					setOptions={setOptions}
					connectorOptions={connectorOptions}
					i18ntitle="optionYtGetTrackInfoFromYtWatchTitle"
					i18nlabel="optionYtGetTrackInfoFromYtWatch"
					connector="YouTube"
					key="enableGetTrackInfoFromYtWatch"
				/>
				<ConnectorOptionEntry
					options={options}
					setOptions={setOptions}
				...
				<ConnectorOptionEntry
					...
					setOptions={setOptions}
					connectorOptions={connectorOptions}
					i18ntitle="optionYtGetTrackInfoFromYtChannelTitle"
					i18nlabel="optionYtGetTrackInfoFromYtChannel"
					connector="YouTube"
					key="enableGetTrackInfoFromYtChannel"
				/>
				<ConnectorOptionEntry
					options={options}
					setOptions={setOptions}
					connectorOptions={connectorOptions}
					i18ntitle="optionYtUseAttributedOnlyForAutoGeneratedTitle"
					i18nlabel="optionYtUseAttributedOnlyForAutoGenerated"
					connector="YouTube"
					key="useAttributedOnlyForAutoGenerated"
				/>
			</ul>
		</>
	);
