...
Connector.currentTimeSelector = `${Connector.playerSelector} [data-test="duration"] [data-test="current-time"]`;

Connector.durationSelector = `${Connector.playerSelector} [data-test="duration"] [data-test="duration-time"]`;
