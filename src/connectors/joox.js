...
function replace_with_rule(rule,output){var max_loop=rule.length;for(var i=0;i<max_loop;i++){var data=rule[i];var from=data.from;var to=data.to;var from_regex=new RegExp(from,"g");output=output.replace(from_regex,to)}
return output}