...
Connector.getTrack = () => {
	...
	return trackName.substr(trackName.indexOf(' ') + 1);
};
...
Connector.trackArtSelector = '.product-image-holder .slick-slide[data-slick-index="0"] img';

Connector.getTrackArt = () => `${location.origin}${Util.extractImageUrlFromSelectors(Connector.trackArtSelector)}`;
