...
export interface ConnectorOptions {
	YouTube: {
		useAttributedOnlyForAutoGenerated: boolean;
		enableGetTrackInfoFromYtChannel: boolean;
		scrobbleMusicOnly: boolean;
		scrobbleEntertainmentOnly: boolean;
		enableGetTrackInfoFromYtWatch: boolean;
...
const DEFAULT_CONNECTOR_OPTIONS: ConnectorOptions = {
	YouTube: {
		useAttributedOnlyForAutoGenerated: false,
		enableGetTrackInfoFromYtChannel: false,
		scrobbleMusicOnly: false,
		scrobbleEntertainmentOnly: false,
		enableGetTrackInfoFromYtWatch: false,
