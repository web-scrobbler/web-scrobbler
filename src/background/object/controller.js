...
import * as ControllerEvent from '@/background/object/controller-event';
...
export default class Controller {
	...
	constructor(tabId, connector, isEnabled) {
		...
		this.shouldScrobblePodcasts = Options.getOption(
	...
	async setSongNowPlaying() {
		...
		const results = await ScrobbleService.sendNowPlaying(
	 ...
	 */
	async scrobbleSong() {
		const results = await ScrobbleService.scrobble(
			this.currentSong.getInfo()
		);
