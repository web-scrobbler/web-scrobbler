...
module.exports = function(grunt) {
	...
	var jsFiles = ['Gruntfile.js', 'popup.js', 'core/background/*', 'core/content/*', 'options/options.js', 'connectors/archive.js', 'popups/*.js']; // intentionally does not contain all files yet
