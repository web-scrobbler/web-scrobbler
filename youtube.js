   ...
   function(request, sender, sendResponse) {
         switch(request.type) {
            ...
            case 'nowPlayingOK':
               ...
               setTimeout('$("#chrome-scrobbler-status").addClass("scrobbled")', min_time*1000) // Turns status message into black when half of videos time has been played, to indicate that we are past the minimum time for a scrobble.   
               break;
